    ...
    internal class AffineDecoder
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    Console.WriteLine("첫번째 복호키의 부호를 설정해주세요.");
                ...
                while (true)
                {
                    Console.WriteLine("첫번째 복호키를 입력하세요.");
                ...
                while (true)
                {
                    Console.WriteLine("두번째 복호키의 부호를 설정해주세요.");
                    Console.WriteLine("+, - 중 입력!");
                ...
                while (true)
                {
                    Console.WriteLine("두번째 복호키를 입력하세요.");
                ...
                //공식 시작
                int.TryParse(S_key0, out key0);//암호키3x+1 복호키9(x-1)
                int.TryParse(S_key1, out key1);//(3, 1), (9, -1)
